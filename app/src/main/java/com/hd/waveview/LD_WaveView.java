...
/**
 * Created by hudong on 2016/12/28.
 */
public class LD_WaveView extends View {
    private static final String TAG ="LD_WaveView" ;
    private int mProgress;//进度
    private int mTimeStep = 2;//时间间隔
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i(TAG, "onMeasure: isMeasure="+isMeasure +",measure_count="+measure_count++);
